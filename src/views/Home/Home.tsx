...
const Home = () => {
  ...
  return (
    <motion.main
      ...
      animate="visible"
    >
      <section className="flex flex-col-reverse md:flex-row items-center justify-center min-h-[calc(100vh-80px)] gap-10 md:gap-20 -mt-10 md:-mt-20">
        <motion.div
        ...
        <motion.div variants={imgVariants} className="relative w-64 h-64 md:w-96 md:h-96 lg:w-[36rem] lg:h-[36rem] rounded-b-full mt-4 overflow-hidden shrink-0">
          <Image
            src={profileImg}
            alt="Rahul Kumar"
            placeholder="blur"
